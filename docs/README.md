...
Sistema IoT de monitoramento de temperatura, umidade e presença de fumaça, desenvolvido para a disciplina de **Sistemas Embarcados** no **IFSP — Campus Catanduva**.
...
- umidade abaixo do limite estabelecido;
- presença de fumaça;
- possível situação de incêndio.

### Modo manual

No modo manual, o cliente pode alterar os estados de sinalização por meio:
...
- [Dashboard do Node-RED](https://nodered.lzmeister.uk/ui)
